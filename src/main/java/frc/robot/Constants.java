...
public final class Constants {
    ...
    public static final class DriveConstants {
        ...
        public static final class Modules {
            ...
            public static final Current DRIVE_CURRENT_LIMIT = Amps.of(70);
            public static final Current STEER_CURRENT_LIMIT = Amps.of(70);

            // the minimum number of seconds it takes the motor to go from 0 to
            // full throttle
            public static final Time DRIVE_RAMP = Seconds.of(0.05);
            ...
            public static final class Offsets {
                ...
                public static final class FL {
                    ...
                    public static final Angle ANGLE = Rotations.of(0.245850);
                ...
                public static final class FR {
                    ...
                    public static final Angle ANGLE = Rotations.of(0.152832);
                    public static final boolean ENCODER_INVERTED = false;
                ...
                public static final class BL {
                    ...
                    public static final Distance Y = BASE_Y;
                    public static final Angle ANGLE = Rotations.of(0.917969);
                    public static final boolean ENCODER_INVERTED = false;
                    public static final boolean DRIVE_INVERTED = false;
                    public static final boolean ANGLE_INVERTED = true;
                }
                public static final class BR {
                    public static final Distance X = BASE_X.times(-1);
                    public static final Distance Y = BASE_Y.times(-1);
                    public static final Angle ANGLE = Rotations.of(0.075928);
                    public static final boolean ENCODER_INVERTED = false;
                    public static final boolean DRIVE_INVERTED = false;
                    public static final boolean ANGLE_INVERTED = true;
                }
    ...
    public static final class TurretConstants {
        ...
        public static final class Offsets {
            public static final Angle YAW_ENCODER = Rotations.of(0);
