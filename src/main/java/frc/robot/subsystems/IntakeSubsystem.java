...
public class IntakeSubsystem extends SubsystemBase {// Cloned From MT (NOT FINALIZED)
    ...
    public IntakeSubsystem() {
      m_intakesubsystemMotor = new SparkFlex(Constants.IntakeConstants.Feeder.CAN_ID, MotorType.kBrushless);//TODO: Change to ACTUAL motor type
            
    }
    public void runIntake() {
    m_intakesubsystemMotor.set(Constants.IntakeConstants.Feeder.INTAKE_SPEED);
