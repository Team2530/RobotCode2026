...
// These are initating the individual Limlight(s)
    ...
    public static final LoaderSubsystem LOADER_SUBSYSTEM = new LoaderSubsystem();
    ...
    private void configureBindings() {
       //This is ment for operator controls
        ...
        driverXbox.leftBumper()
             .whileTrue(new LoaderCommand(LOADER_SUBSYSTEM));
        driverXbox.a()
             .whileTrue(new ShooterCommand(SHOOTER_SUBSYSTEM));
