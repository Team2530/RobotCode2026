...
public final class Constants {
    ...
    public static class PID {
         ...
         * PID Constants that can set PID Values and get needed controllers and config.
         */
        public PID(double P, double I, double D, double F, double IZ) {
            this.P = P;
            this.I = I;
            this.D = D;
            this.F = F;
        ...
        public PIDFConfig getPIDFConfig() {
            return new PIDFConfig(P, I, D, F, IZ);
        }
    }
    ...
    public static final class DriveConstants {
        ...
        public static final ConversionFactorsJson conversionFactors = new ConversionFactorsJson() {
            {
        ...
        public static final PIDFConfig DRIVE_PID = DriveConstants.PIDs.Drive.getPIDFConfig();
        public static final PIDFConfig ANGLE_PID = DriveConstants.PIDs.Angle.getPIDFConfig();

        public static final SwerveModulePhysicalCharacteristics PHYSICAL_CHARACTERISTICS = new SwerveModulePhysicalCharacteristics(
                conversionFactors,
        ...
        public static final SwerveModuleConfiguration MODULES[] = {
                new SwerveModuleConfiguration(
                        ...
                        ANGLE_PID, DRIVE_PID, PHYSICAL_CHARACTERISTICS,
                ...
                new SwerveModuleConfiguration(
                        ...
                        new SwerveDriveConfiguration(
                            MODULES, 
                            new Pigeon2Swerve(IMU.CANID), 
                            IMU.INVERTED,
                            PHYSICAL_CHARACTERISTICS
                    );
        
                    public static final PIDFConfig HEADING_PID = PIDs.Heading.getPIDFConfig();
        
                    public static final SwerveControllerConfiguration CONTROLLER_CONFIGURATION = 
                        new SwerveControllerConfiguration(
                            DRIVE_CONFIGURATION,
                            HEADING_PID,
                            ControlConstants.Deadband.HEADING,
        ...
        public static final class SwerveModules {
            ...
            public static final class CanIDs {
                ...
                public static final int FR_CANCODER = 9;
            ...
            public static final class Offsets {
                ...
                public static final double FL_ANGLE = 0.073975;
                ...
                public static final double FR_ANGLE = 0.918457;
                ...
                public static final double BL_ANGLE = 0.653564;
                ...
                public static final double BR_ANGLE = 0.246826;
    ...
    public static final class PoseConstants {
        ...
        private static final AprilTagFieldLayout TAG_LAYOUT = AprilTagFieldLayout
